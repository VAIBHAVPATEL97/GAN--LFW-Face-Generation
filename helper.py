...
def images_square_grid(images, mode):
    ...
    #plt.savefig('save_size'+str(i)+'.png')
    ...
    for col_i, col_images in enumerate(images_in_square):
        for image_i, image in enumerate(col_images):
            ...
            #plt.savefig('Colin_Powell_'+str(image_i)+str(col_i)+'.jpeg')
            plt.savefig('Carlos_Menem.'+str(image_i)+str(col_i)+'.jpeg', bbox_inches='tight', pad_inches=0, dpi= None)
